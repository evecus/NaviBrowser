...
class SettingsCategoryActivity : AppCompatActivity() {
    ...
    private fun wirePrivacySection() {
        ...
        bindSwitch(R.id.switchUpdatePassword, prefs.passwordUpdatePromptEnabled) { prefs.passwordUpdatePromptEnabled = it }
        bindSwitch(R.id.switchAutoFillOnLoad, prefs.autoFillOnLoadEnabled) { prefs.autoFillOnLoadEnabled = it }
